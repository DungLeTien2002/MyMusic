package com.example.mymusic.base.adapter.home
...
import com.example.mymusic.databinding.ItemHomeContentArtistBinding
import com.example.mymusic.databinding.ItemHomeContentPlaylistBinding
import com.example.mymusic.databinding.ItemHomeContentSongBinding
import com.example.mymusic.databinding.ItemHomeContentVideoBinding


class HomeItemContentAdapter(
    ...
    inner class AlbumViewHolder(
        var binding: ItemHomeContentPlaylistBinding,
        var listener: onAlbumItemClickListener
    ) : RecyclerView.ViewHolder(binding.root) {
        init {
    ...
    inner class ArtistViewHolder(
        var binding: ItemHomeContentArtistBinding,
        var listener: onArtistItemClickListener
    ) : RecyclerView.ViewHolder(binding.root) {
        init {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            ...
            ALBUM -> AlbumViewHolder(
                ItemHomeContentPlaylistBinding.inflate(inflate, parent, false),
                mAlbumListener
            )
