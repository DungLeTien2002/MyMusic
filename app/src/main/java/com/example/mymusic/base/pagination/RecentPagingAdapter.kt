package com.example.mymusic.base.pagination
...
import com.example.mymusic.databinding.ItemAlbumSearchResultBinding
import com.example.mymusic.databinding.ItemArtistSearchResultBinding
import com.example.mymusic.databinding.ItemPlaylistSearchResultBinding
import com.example.mymusic.databinding.ItemSongsSearchResultBinding


class RecentPagingAdapter(private val context: Context): PagingDataAdapter<Any, RecyclerView.ViewHolder>(
    DIFF_CALLBACK
) {
