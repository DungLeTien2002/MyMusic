package com.example.mymusic.base.data.parser
...
import com.example.mymusic.base.models.AlbumItem
import com.example.mymusic.base.models.ArtistItem
import com.example.mymusic.base.models.MusicResponsiveListItemRenderer
import com.example.mymusic.base.models.MusicTwoRowItemRenderer
import com.example.mymusic.base.models.PlaylistItem
import com.example.mymusic.base.models.Run
import com.example.mymusic.base.models.SectionListRenderer
...
fun Thumbnail.toThumbnail(): com.example.mymusic.base.models.searchResult.song.Thumbnail {
    return com.example.mymusic.base.models.searchResult.song.Thumbnail(
...
fun List<Thumbnail>.toListThumbnail(): List<com.example.mymusic.base.models.searchResult.song.Thumbnail> {
    val list = mutableListOf<com.example.mymusic.base.models.searchResult.song.Thumbnail>()
    this.forEach {
        ...
        HomeItem(
            ...
            contents = explore.released.map {
                Content(
                    ...
                    browseId = it.id,
                    thumbnails = listOf(
                        com.example.mymusic.base.models.searchResult.song.Thumbnail(
                            522,
                            it.thumbnail,
                            522
                        )
